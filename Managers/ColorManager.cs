...
// On level up and level set cycle out the pair of complementary colors shading the play area.
public class ColorManager : MonoBehaviour {
    ...
    private static ColorManager _S;
    public static ColorManager S { get { return _S; } set { _S = value; } }
